<template>
  <div>
    <el-dialog title="任务监听器" :visible.sync="dialogVisible" width="900px" :close-on-click-modal="true"
          :close-on-press-escape="false" :show-close="false" @closed="$emit('close')" v-drag>
