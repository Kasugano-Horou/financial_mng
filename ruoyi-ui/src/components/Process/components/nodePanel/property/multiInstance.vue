<template>
  <div>
    <el-dialog title="多实例配置" :visible.sync="dialogVisible" width="500px" :close-on-click-modal="true"
          :close-on-press-escape="false" :show-close="false" class="muti-instance" @closed="$emit('close')" v-drag>
      <el-alert
        type="info"
        :closable="false"
        show-icon
