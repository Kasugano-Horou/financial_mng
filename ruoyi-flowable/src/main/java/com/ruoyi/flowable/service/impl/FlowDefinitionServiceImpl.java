...
public class FlowDefinitionServiceImpl extends FlowServiceFactory implements IFlowDefinitionService {
    ...
    @Override
    public int queryProcDefCount(String category) {
     ...
     */
    @Override
    public List<FlowProcDefDto> queryProcDefList(String category, int pageNo, int pageSize) {
        // 流程定义列表数据查询
        ProcessDefinitionQuery procDefQuery = repositoryService.createProcessDefinitionQuery();
        if (category != null) {
            procDefQuery.processDefinitionCategory(category);
        }
        procDefQuery.orderByProcessDefinitionVersion().desc()
        ...
        for (ProcessDefinition procDef : procDefList) {
            ...
            BeanUtils.copyProperties(procDef, reProcDef);
    ...
    public Response<Integer, Void> startProcessInstanceById(String procDefId, Map<String, Object> variables) {
        ...
        if (Objects.nonNull(procDef) && procDef.isSuspended()) {
...
//           variables.put(ProcessConstants.FLOWABLE_SKIP_EXPRESSION_ENABLED, true);
        ...
        Task task = taskService.createTaskQuery().processInstanceId(procIns.getProcessInstanceId()).singleResult();
        if (Objects.nonNull(task)) {
            taskService.addComment(task.getId(), procIns.getProcessInstanceId(), FlowComment.NORMAL.getType()
